import {Text, Menu,MenuButton,MenuList,MenuItem, useColorModeValue,useColorMode, Flex,
   Input,Button ,InputGroup,InputLeftElement, FormLabel, Box} from '@chakra-ui/react'
...
<Menu>
  ...
  width={"full"}
  colorScheme='blue'
  as={Button} rightIcon={<IoChevronDown fontSize={25}/>}>
   {category}
  </MenuButton>
